        ...
        <Container className="position-relative">
          ...
          >
            ...
            <p className="resume-subtitle">
              Get to know more about who I am, what I do, and what I'm
              passionate about
            </p>
          </motion.div>
          ...
          <Row className="align-items-center ">
            ...
            <Col
              lg={6}
              md={12}
              className={`mb-4 mb-lg-0 ${isMobile ? "text-center" : ""}`}
            >
              <motion.div
            ...
            <Col lg={6} md={12}>
              ...
              >
                ...
                <motion.div variants={textVariants} className="mb-4">
                  <span className="about-title">Hi There! I'm </span>
                  <motion.span
                ...
                <motion.div variants={textVariants} className="mb-4">
                  <p className="about-description">
                    ...
                    creating engaging and interactive user interfaces. My
                    mission is to craft digital experiences that not only look
                    stunning but also provide seamless functionality, guiding
                    users through their journey and helping them achieve their
                    goals with ease and satisfaction.
                  </p>
                </motion.div>
                ...
                {/* Action Button */}
                <motion.div variants={textVariants} className="about-actions">
                  <motion.div
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
