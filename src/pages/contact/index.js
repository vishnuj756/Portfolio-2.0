              ...
              return (
                ...
                >
                  <Row>
                    ...
                    <Col md={10} sm={6} style={{ cursor: "pointer" }}>
                      <h5 className={`text-white  mb-1 ${deviceType==="mobile"?"text-center":""}`}>{item.type}</h5>
                      <p className={deviceType==="mobile"?"text-center":""}>{item.value}</p>
                    </Col>
                  </Row>
                </motion.div>
              );
